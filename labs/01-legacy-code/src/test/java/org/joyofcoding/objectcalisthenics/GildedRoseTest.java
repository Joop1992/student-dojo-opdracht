...
public class GildedRoseTest {
    ...
    public void after_one_day_with_sufuras_having_sellIn_lesser_than_zero_and_quality_greater_than_zero() {
        ...
        items.add(Item.builder()
                ...
                .itemProperties(ItemProperties.builder()
                        .sellIn(-1)
                        .quality(1)
                        .build())
                .build());
    ...
    private Item aRandomBackstagePass() {
        ...
        return Item.builder().name("Backstage passes to a TAFKAL80ETC concert").itemProperties(ItemProperties.builder
                ().sellIn(sellIn).quality(quality).build()).build();
    }
}
